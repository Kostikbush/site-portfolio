...
export const MySkils = () => {
  ...
  const plusLeft = () => {
    if (numberPlusMinusOffset === 615 && offset < -3500) {
      setOffset(0);
    } else if (numberPlusMinusOffset === 280 && offset < -3400) {
      setOffset(0);
    } else if (numberPlusMinusOffset === 230 && offset < -2800) {
      setOffset(0);
    } else {
          ...
          <div className="container">
            <div className="gallery relative">
              <figure className="item gallery__item gallery__item--1">
                <a
                  target="_blank"
                  href="https://kostikbush.github.io/Cool-Elements-for-the-site_sort/"
              ...
              <figure className="item gallery__item gallery__item--2">
                <a
                  target="_blank"
                  href="https://todo-app-3vhjez0at-kostikbush.vercel.app/"
                  className="absolute w-full h-full top-0 left-0 z-50"
                ></a>
                <img
                  src={todo}
              ...
              <figure className="item gallery__item gallery__item--3">
                <a
                  target="_blank"
                  href="https://kostikbush.github.io/MoGo/"
                  className="absolute w-full h-full top-0 left-0 z-50"
                ></a>
                <img
                  src={mogo}
              ...
              <figure className="item gallery__item gallery__item--4">
                <a
                  target="_blank"
                  href="https://kostikbush.github.io/MNTN/"
                  className="absolute w-full h-full top-0 left-0 z-50"
                ></a>
                <img
                  src={mntn}
              ...
              <figure className="item gallery__item gallery__item--5">
                <a
                  target="_blank"
                  href="https://kostikbush.github.io/post-like/"
                  className="absolute w-full h-full top-0 left-0 z-50"
                ></a>
                <img
                  src={post}
              ...
              <figure className="item gallery__item gallery__item--6">
                <a
                  target="_blank"
                  href="https://kostikbush.github.io/posts-json-placeholder/"
                  className="absolute w-full h-full top-0 left-0 z-50"
                ></a>
                <img
                  src={posts}
              ...
              <figure className="item gallery__item gallery__item--7">
                <a
                  target="_blank"
                  href="https://kostikbush.github.io/Cool-Elements-for-the-site_dropdown_piple/"
                  className="absolute w-full h-full top-0 left-0 z-50"
                ></a>
              ...
              <figure className="item gallery__item gallery__item--8">
                <a
                  target="_blank"
                  href="https://kostikbush.github.io/clock/"
                  className="absolute w-full h-full top-0 left-0 z-50"
                ></a>
                <img
                  src={clock}
              ...
              <figure className="item gallery__item gallery__item--9">
                <a
                  target="_blank"
                  href="https://kostikbush.github.io/like-cats/"
                  className="absolute w-full h-full top-0 left-0 z-50"
                ></a>
                <img
                  src={cats}
